...
You can see from this that the Gamma test estimate of noise in a data relationship is quite accurate, of course we are using about twice as much data as the M test tells us we need:
